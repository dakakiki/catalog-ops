    ...
    <div>
      ...
      <article id="privacy">
        ...
        <?php else : ?>
          ...
          <p>We are established in Serbia, which is outside the EEA and is <strong>not</strong> covered by an adequacy decision of the European Commission. We reach the data described above by logging in to those EEA services from Serbia; it is not copied here in the ordinary course. That access is made on the basis of <code class="fill">[TRANSFER BASIS]</code>.</p>
