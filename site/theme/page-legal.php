    ...
    <div>
      ...
      <article id="privacy">
        ...
        <?php else : ?>
          ...
          <p>CatalogOps is run by <code class="fill">[FULL NAME]</code>, an individual trader in Serbia.</p>
          <ul>
          ...
          <ul>
            ...
            <li>Retention: <code class="fill">[N]</code> days, then deleted.</li>
          </ul>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr><td><code class="fill">[HOSTING PROVIDER]</code></td><td>The server this site runs on</td></tr>
          ...
          <p>We are in Serbia. Serbia has an adequacy decision from the European Commission for the transfer of personal data, so data reaching us from the EEA does so on that basis. Freemius is in the United States and handles transfers under its own published safeguards.</p>
      ...
      <article id="terms">
        ...
        <?php else : ?>
          ...
          <p>CatalogOps is made and supported by <code class="fill">[FULL NAME]</code>, an individual trader in Serbia, reachable at <strong>contact@catalog-ops.app</strong>.</p>
          ...
          <h3>Refunds</h3>
          <p>Fourteen days, any reason, no questions asked, one guarantee per customer. The whole policy is in the <a href="#refunds">Refund Policy</a>.</p>
      ...
      <article id="refunds">
        ...
        <?php else : ?>
          ...
          <h3>One guarantee per customer</h3>
          <p>The guarantee exists so that a <em>first</em> purchase carries no risk. It is not a way to use the plugin a fortnight at a time.</p>
          <p>If you have already had a refund, a later purchase is final. Nothing else changes — you still get the free tier to evaluate with, for as long as you like.</p>
