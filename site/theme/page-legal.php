    ...
    <div>
      ...
      <article id="privacy">
        ...
        <?php else : ?>
          ...
          <p>We are established in Serbia, which is outside the European Economic Area and is <strong>not</strong> covered by an adequacy decision of the European Commission. Where personal data reaches us from the EEA or the UK, it is transferred on the basis of <code class="fill">[TRANSFER BASIS]</code>.</p>
          <p>The GDPR and the UK GDPR apply to us directly, because CatalogOps is offered to customers in those territories.</p>
          <p>Two of the services named above sit outside Serbia. <strong>Freemius Inc.</strong> is in the United States and is an independent controller for the payment; transfers to Freemius are governed by its own published safeguards and its privacy policy. <strong>Plausible Analytics</strong> is hosted in the European Union, so audience measurement involves no transfer out of the EEA.</p>
